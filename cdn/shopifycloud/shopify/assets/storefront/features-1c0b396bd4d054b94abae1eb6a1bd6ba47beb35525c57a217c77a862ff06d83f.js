...
//                         return P.call(this)
//                     }), S && !p || !e && !g && A[n] || m(A, n, E), T[u] = E, T[_] = c, f)
//                     if (h = {
//                             values: x ? E : v(i),
//                             keys: l ? E : v(o),
//                             entries: j
...
//                         if ((l = n ? h(a(s = t[d])[0], s[1]) : h(t[d])) === e || l === r) return l
//                 } else
...
//             }), O(O.G + O.W + O.F * !m, {
//                 Promise: h
//             }), G(h, f), st(f), o = _[f], O(O.S + O.F * !m, f, {
//                 reject: function(t) {
//                     var n = v(this);
...
//                         f = 0,
//                         l = Q(i);
//                     if (a && (s = E(s, c > 2 ? arguments[2] : void 0, 2)), null == l || u == Array && $(l))
//                         for (e = new u(n = k(i.length)); n > f; f++) lt(e, f, a ? s(i[f], f) : i[f]);
//                     else
//                         for (o = l.call(i), e = new u; !(r = o.next()).done; f++) lt(e, f, a ? Y(o, s, [r.value, f], !0) : r.value);
//                     return e.length = f, e
//                 }
//             })
//         })), t((function() {
