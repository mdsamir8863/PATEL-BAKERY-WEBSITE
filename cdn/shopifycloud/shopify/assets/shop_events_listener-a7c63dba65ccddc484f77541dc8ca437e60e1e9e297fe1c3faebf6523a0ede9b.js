...
//                 i = void 0;
//             try {
//                 for (var c, s = decodeURI(e).split("&")[Symbol.iterator](); !(a = (c = s.next()).done); a = !0) {
//                     var d = c.value.split("="),
//                         u = d[0].match(/items\[(\d+)\]\[(\w+)\].*/);
//                     if (u) {
//                         var l = u[1],
//                             y = u[2];
//                         "quantity" === y ? n[l].quantity = d[1] : "id" === y && (n[l].id = d[1])
//                     }
//                 }
//             } catch (e) {
//                 o = !0, i = e
...
//             }]), e
//         }();
//         p.ADD_TO_CART_REGEX = /^(?:\/[a-zA-Z]+(?:\-[a-zA-Z]+)?)?\/cart\/add(?:\.js|\.json)?$/, a.default = p,
//             function() {
//                 function e(e, t, n) {
...
//                                     referer: window.location.href
//                                 }, i);
//                             window.ShopifyAnalytics.lib.track("Added Product", c), window.ShopifyAnalytics.lib.track("monorail://trekkie_storefront_track_added_product/1.1", s)
//                         } catch (e) {
...
//                     } else window.ShopifyAnalytics.meta.product && (n = c(e, t = window.ShopifyAnalytics.meta.product));
//                     return t ? (r = {
//                         productId: t.id,
//                         productGid: t.gid,
//                         brand: t.vendor,
...
//                     }
//                 }))
//             }(), y = XMLHttpRequest, f = y.prototype.open, h = y.prototype.send, y.prototype.open = function(e, t) {
//                 this._url = t, this._method = e, p.handleXhrOpen(), f.apply(this, arguments)
//             }, y.prototype.send = function(e) {
//                 var t = new p(this, this._url, this._method, e);
//                 this.addEventListener ? this.addEventListener("readystatechange", t.onReadyStateChange.bind(t), !1) : (t.oldOnReadyStateChange = this.onreadystatechange, this.onreadystatechange = t.onReadyStateChange), h.call(this, e)
//             },
//             function(e, t) {
//                 function n(e, t) {
